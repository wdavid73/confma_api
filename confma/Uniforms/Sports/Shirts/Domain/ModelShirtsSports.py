...
class ShirtsSports(models.Model):
    ...
    image = models.ImageField(upload_to='uniforms/sports/shirts/%Y/%m/%d/', null = True)
    ...
    def get_absolute_url(self):
        return reverse("confma:shirst_sport_detail", kwargs={'_id': self.id})
