...
urlpatterns = [
    ...
    path('isvalidcloth/<int:id>/' , quotation.isValidCloth , name="isvalidCloth"),
    ...
    path('quotations_clients/clientnotduplicated/<int:_id>/', quotation_client.ClientNotDuplicatedInQuotation,
